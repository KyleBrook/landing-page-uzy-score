import { Brain, Database, Eye, Workflow, Building, FileText, Scale, Globe } from 'lucide-react';
  ...
  return (
    <div className="relative w-full h-96 flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        {/* Formas geométricas */}
        <div className="absolute top-10 left-10 w-16 h-16 bg-emerald-100 rounded-lg transform rotate-12 opacity-60"></div>
        <div className="absolute top-20 right-20 w-12 h-12 bg-blue-100 rounded-full opacity-60"></div>
        <div className="absolute bottom-20 left-20 w-20 h-20 bg-purple-100 rounded-lg transform -rotate-12 opacity-60"></div>
        <div className="absolute bottom-10 right-10 w-14 h-14 bg-orange-100 rounded-full opacity-60"></div>
        
        {/* Linhas conectoras */}
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <path d="M 100 100 Q 200 150 300 100" stroke="currentColor" strokeWidth="2" fill="none" className="text-emerald-300 opacity-30" />
          <path d="M 400 200 Q 300 250 200 200" stroke="currentColor" strokeWidth="2" fill="none" className="text-blue-300 opacity-30" />
        </svg>
      </div>
      ...
      <div className="relative z-10">
        <div className="relative">
          ...
          <div className="w-80 h-48 bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg shadow-2xl transform perspective-1000 rotateX-10 rotateY-5">
            ...
            <div className="absolute -top-32 left-4 w-72 h-44 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg shadow-xl">
              <div className="p-4 h-full flex flex-col justify-center items-center text-white">
                ...
                <div className="text-sm font-medium">ScoreFy IA</div>
          ...
          <div className="absolute -top-20 -left-20">
            <div className="bg-white rounded-full px-4 py-2 shadow-lg border border-emerald-200">
          ...
          <div className="absolute -top-16 -right-24">
            <div className="bg-white rounded-full px-4 py-2 shadow-lg border border-blue-200">
              <div className="flex items-center gap-2">
          ...
          <div className="absolute top-12 -right-32">
            <div className="bg-white rounded-full px-4 py-2 shadow-lg border border-orange-200">
              <div className="flex items-center gap-2">
          ...
          {/* Elementos 3D adicionais */}
          <div className="absolute -bottom-8 -left-16 w-16 h-16 bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-lg shadow-lg transform rotate-12">
            <div className="w-full h-full flex items-center justify-center">
              <Database className="w-8 h-8 text-white" />
            </div>
          </div>

          <div className="absolute -bottom-6 -right-20 w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-500 rounded-lg shadow-lg transform -rotate-12">
            <div className="w-full h-full flex items-center justify-center">
